...
return array(
  ...
  'Task history emailed to the task creator @"%s" with subject "%s".' => 'Historique des tâches envoyé par e-mail au créateur de la tâche @"%s" avec le sujet "%s".',
  'Task history emailed to the project email address with subject "%s".' => 'Historique des tâches envoyé par e-mail à l\'adresse e-mail du projet avec le sujet "%s".',
  //
